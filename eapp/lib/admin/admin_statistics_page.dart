...
class _AdminStatisticsPageState extends State<AdminStatisticsPage> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // عرض الإحصائيات في قائمة بدلاً من الشبكة
            Expanded(
              child: ListView(
                children: [
                  ...
                  buildStatisticTile("جاهز للتسليم", readyOrders, Icons.local_shipping, Colors.blueAccent),
  ...
  // ودجت مخصصة لعناصر الإحصائيات في القائمة
